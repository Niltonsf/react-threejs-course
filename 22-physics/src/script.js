...
window.addEventListener('click', async () => {
	if (currentIntersect !== null) {
		const bodyOfObject = objectsToUpdate.find((el) => el.mesh === currentIntersect.object).body;	
		bodyOfObject.applyLocalForce(new CANNON.Vec3(200, 0, 0), new CANNON.Vec3(1, 0, 0));	
	}
});

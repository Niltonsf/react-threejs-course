...
const glithScreenPass = new GlitchPass();
glithScreenPass.goWild = false;
glithScreenPass.enabled = false;
effectComposer.addPass(glithScreenPass);
...
gui.add(unrealBloomPass, 'strength', 0, 1, 0.001).name('Strength');
gui.add(unrealBloomPass, 'radius', 0, 1, 0.001).name('Radius');
